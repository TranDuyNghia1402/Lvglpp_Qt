...
constexpr auto qt_meta_stringdata_CLASSGraphicENDCLASS = QtMocHelpers::stringData(
    "Graphic",
    "onThreadStarted",
    "",
    "onLvTickHandler",
...
void Graphic::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onThreadStarted(); break;
        case 1: _t->onLvTickHandler(); break;
        case 2: _t->onLvTimerHandler(); break;
        default: ;
        }
    }
    (void)_a;
